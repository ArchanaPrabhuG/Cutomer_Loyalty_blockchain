...
app.post('/api/registerPartner', function(req, res) {
  ...
  //print variables
  console.log('Using param - Name: ' + name + ' PartnerId: ' + partnerId + ' Access Key: ' + cardId);
...
app.post('/api/earnPoints', function(req, res) {
  ...
  //print variables
  console.log('Using param - MarCoins: ' + points + ' PartnerId: ' + partnerId + ' AccountNumber: ' + accountNumber + ' Access Key: ' + cardId);
...
app.post('/api/memberData', function(req, res) {
  ...
  //print variables
  console.log('memberData using param - ' + ' AccountNumber: ' + accountNumber + ' Access Key: ' + cardId);
...
app.post('/api/partnerData', function(req, res) {
  ...
  //print variables
  console.log('partnerData using param - ' + ' PartnerId: ' + partnerId + ' Access Key: ' + cardId);
