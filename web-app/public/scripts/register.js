...
$('.register-member').click(function() {
  ...
  var formMemCardId = $('.member-card-id input').val();
  ...
  //create json data
  var inputData = '{' + '"firstname" : "' + formFirstName + '", ' + '"lastname" : "' + formLastName + '", ' + '"email" : "' + formEmail + '", ' + '"phonenumber" : "' + formPhoneNumber + '", ' + '"accountnumber" : "' + formAccountNum + '", ' + '"cardid" : "' + formMemCardId + '"}';
...
$('.register-partner').click(function() {
  ...
  //get user input data
  var formName = $('.partner-name input').val();
  var formPartnerId = $('.partner-id input').val();
  var formPartCardId = $('.partner-card-id input').val();

  //create json data
  var inputData = '{' + '"name" : "' + formName + '", ' + '"partnerid" : "' + formPartnerId + '", ' + '"cardid" : "' + formPartCardId + '"}';
  console.log(inputData)
